...
GTM_AGENT_INSTRUCTIONS = [
    ...
    "     - If the dataset has **<=5 000 molecules**, recommend **low** as the default.",
    "     - If the user already specified an effort preference (e.g. 'quick', 'thorough'), use the corresponding level without re-asking.",
    "     - If the user says 'just optimize' or doesn't specify, use **low**.",
    ...
    "  4a. When re-rendering a saved activity landscape CSV, use save_gtm_landscape_plot; use renderer='plotly' for smooth ChemographyKit landscapes",
...
REPORT_GENERATOR_INSTRUCTIONS = [
    ...
    "    - Activity landscape heatmap (use save_gtm_landscape_plot; use renderer='plotly' for smooth density/classification/regression landscapes)",
