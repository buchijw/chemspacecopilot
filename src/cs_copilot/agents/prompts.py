...
CHEMOINFORMATICIAN_INSTRUCTIONS = [
    ...
    "  It detects user dataset activity columns such as IC50/EC50/Ki/Kd/MIC, pIC50/pKi/pChEMBL, activity, label, and class; use the returned activity_mapping when discussing activity direction or units.",
    "",
...
AGENT_TEAM_INSTRUCTIONS = [
    ...
    "  - Resolve references to stable IDs such as cmp_001, map_001, zone_001, or route_001 before delegating to a member agent.",
