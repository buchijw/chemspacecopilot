...
AGENT_TEAM_INSTRUCTIONS = [
    ...
    "  - Generated candidate sets from Molecular Designer runs are stored as compact candidate_set objects with artifact paths and selected as `current['candidate_set']` / `current['generated_compounds']`; those runs record `generation_engine='llm'` or `generation_engine='autoencoder'`.",
