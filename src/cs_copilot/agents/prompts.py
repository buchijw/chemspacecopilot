...
REPORT_GENERATOR_INSTRUCTIONS = [
    ...
    "    - For every explicitly discussed key structure (top scaffolds, named SAR examples, generated/reference compounds, and notable activity outliers), assign both a simple ID and a descriptive name.",
    "    - Use simple IDs sequentially by type: Scaffold-1, Scaffold-2, ... and Molecule-1, Molecule-2, ... .",
